...
from mppii.tasks.particle_box import ParticleBox
...
parser = argparse.ArgumentParser(
    description="Run an interactive simulation of the particle with box constraint task."
)
parser.add_argument(
    "--optimize-gains",
    action="store_true",
...
task = ParticleBox(optimize_gains=args.optimize_gains)
